...
// FIX 1: Correct the import to match the pdfParse function called below
...
// FIX 2: REMOVED app.get("/") so it doesn't hijack your index.html page!
...
app.post("/api/chat", async (req, res) => {
    try {
        ...
        // FIX 3: Moved console logs inside the try block where 'message' is actually defined
